// WCA — Supabase Directory

// ═════════════════════════════════════════════════════════════════
// === RESET DIRECTORY SUPABASE ===
// ═════════════════════════════════════════════════════════════════
...
// Auto-backfill & startup timers
setTimeout(updateDirHeaderCounts, 500);
setTimeout(loadDirStatsFromSupabase, 2000);
setTimeout(refreshDbCounters, 2500);

// Backfill automatico se non fatto
